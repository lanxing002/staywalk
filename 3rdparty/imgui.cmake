...
if (IMGUI_SIMPLE_EXAMPLE)
    add_executable(imgui-test WIN32 ${CMAKE_CURRENT_SOURCE_DIR}/imgui/examples/example_glfw_opengl3/main.cpp)
    target_link_libraries(imgui-test PUBLIC imgui ${gl3_lib})
