...
//        glm::vec4 a = projection2 * glm::vec4(0.0, .0, -0.1, 1.0);
//        a /= a.w;
//        glm::vec4 a1 = projection2 * glm::vec4(0.0, .0, .0, 1.0);
//        a1 /= a1.w;
//        glm::vec4 b = projection2 * glm::vec4(0.0, .0, -100, 1.0);
//        b /= b.w;
//        glm::vec4 c = projection2 * glm::vec4(0.0, .0, -10, 1.0);
//        c /= c.w;
//        glm::vec4 d = projection2 * glm::vec4(0.0, .0, -200, 1.0);
//        d /= d.w;
